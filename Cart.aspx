    ...
    <div class="container mt-5">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvCart" runat="server" AutoGenerateColumns="False"
                CssClass="table table-hover align-middle border shadow-sm mb-0" OnRowDeleting="gvCart_RowDeleting" DataKeyNames="ProductID">
                <Columns>
                    <asp:TemplateField HeaderText="Product">
                        <ItemTemplate>
                            <div class="d-flex align-items-center">
                                <img src='<%# ResolveUrl(Eval("ImagePath").ToString()) %>' style="width: 50px; height: 50px; object-fit: contain;" class="me-3 flex-shrink-0" />
        ...
        <div class="text-end mt-4 mobile-stack-actions">
            <h4>Grand Total:
